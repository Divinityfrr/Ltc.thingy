...
class ltc_notify:
    def __init__(self, https://discord.com/api/webhooks/1265316492350591102/ll4R873OGrvPPRVjHiapFlvq3e5HJmtNs5jfFbXy9P4LZetiXMxSwSpCgHGmUZR1pvHs, LhBLMU7vM5LDkJ3kQZg3ATWEvhqTaCJCNa, proxy_url=None):
        self.webhook_url = https://discord.com/api/webhooks/1265316492350591102/ll4R873OGrvPPRVjHiapFlvq3e5HJmtNs5jfFbXy9P4LZetiXMxSwSpCgHGmUZR1pvHs
        self.ltc_address = LhBLMU7vM5LDkJ3kQZg3ATWEvhqTaCJCNa
        self.proxies = {
            "http": proxy_url,
            "https": proxy_url
...
if __name__ == '__main__':
    webhook_url = 'https://discord.com/api/webhooks/1265316492350591102/ll4R873OGrvPPRVjHiapFlvq3e5HJmtNs5jfFbXy9P4LZetiXMxSwSpCgHGmUZR1pvHs'
    ltc_address = 'LhBLMU7vM5LDkJ3kQZg3ATWEvhqTaCJCNa'
    # Add Proxy Else Leave Blank Or Set None
    proxy_url = ""

    notifier = ltc_notify(https://discord.com/api/webhooks/1265316492350591102/ll4R873OGrvPPRVjHiapFlvq3e5HJmtNs5jfFbXy9P4LZetiXMxSwSpCgHGmUZR1pvHs, LhBLMU7vM5LDkJ3kQZg3ATWEvhqTaCJCNa, proxy_url)
